const editComment = async (event) => {
  ...
  console.log(event);
  // Collect values from the edit comment form
  ...
  if (content) {
    ...
    if (response.ok) {
      // If successful, redirect the browser to blogpost's page
...
document.querySelector(".comment-form").addEventListener("submit", editComment);
